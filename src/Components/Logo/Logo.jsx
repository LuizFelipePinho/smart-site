        ...
        <>
            <svg className="svg-img">
                <g className="svg-img-g">
                    ...
                    <rect x="114.7" y="2.2" className="st0" width="6.7" height="5.5"/>
                    <path className="st0" d="M145.4,38.4c-5.9,9.3-16.2,15.4-28,15.4c-11.8,0-22.1-6.1-28-15.4c6.9,6.4,16.9,10.3,28,10.3
                        C128.5,48.8,138.5,44.8,145.4,38.4"/>
                    <path className="st1" d="M0.8,32.3v-3.6c1.9,0.8,4.2,1.2,6.7,1.2c1.9,0,2.8-0.6,2.8-1.8c0-1.1-0.6-1.7-1.9-1.7H5.3
